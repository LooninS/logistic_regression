...
A pure NumPy and pandas implementation of Logistic Regression for binary classification, built from scratch without any machine learning libraries.
...
- **Task**: Predict whether a user will purchase a product based on their demographic information
